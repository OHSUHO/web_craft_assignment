...
public class ChatService {
    ...
    public List<ChatMessageResponse> getRecentMessages(Long worldId, int limit) {
        ...
        for (ChatMessage chatMessage : recent.reversed()) {

           result.add(new ChatMessageResponse(chatMessage.getSenderNickname(), chatMessage.getContent(),chatMessage.getCreatedAt()));
        }
