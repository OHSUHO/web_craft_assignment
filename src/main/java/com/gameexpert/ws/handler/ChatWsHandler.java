...
public class ChatWsHandler implements WsMessageHandler {
    ...
    private ChatResponse createResponse(WsMessageContext context, String content) {
        ...
        ChatMessageResponse cmr = chatService.saveMessage(context.worldId(),context.nickname(),content);
        return new ChatResponse(cmr.getSender(),cmr.getContent(),cmr.getCreatedAt());
    }
}
